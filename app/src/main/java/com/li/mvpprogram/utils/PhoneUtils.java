...
public class PhoneUtils {
     ...
     * 读取手机通讯录数据
     */
//    public static List<MemberVo> readContacts(Context context) {
//        Cursor cursor = null;
...
//                    //名字
//                    String name1 = cursor.getString(cursor.getColumnIndex
//                            (ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME));
//                    if (!TextUtils.isEmpty(name1)) {//空格处理
...
//                    }
//                    //电话号码
//                    String phoneNumber1 = cursor.getString(cursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER));
//                    if (!TextUtils.isEmpty(phoneNumber1)) {
//                        String phoneNumber2 = phoneNumber1.replaceAll(" ", "");
//                        memberVo.setMobilePhone(phoneNumber2);
//                    } else {
//                        memberVo.setMobilePhone(phoneNumber1);
//                    }
//
...
//    public static List<MemberVo> getPhoneContacts(Context context) {
...
//                    info.setShowName(name.replace(" ",""));
//                }else{
//                    info.setShowName(name);
//                }
//                if (!StringUtils.isEmpty(number)){
//                    info.setMobilePhone(number.replace(" ",""));
//                }else{
//                    info.setMobilePhone(number);
//                }
//                //保存到集合里
//                memberVos.add(info);
//            }
