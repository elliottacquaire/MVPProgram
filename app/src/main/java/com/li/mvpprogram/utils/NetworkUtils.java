...
public class NetworkUtils {
    ...
    private NetworkUtils() {
        throw new UnsupportedOperationException("you can't create NetworkUtils object");
    }
    ...
    public class Constants {
        ...
        // No network
        public static final int NETWORK_NO = 5;
    ...
    public static int getCurNetworkType(Context context) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) { // 有网络连接
            ...
            netWorkType = Constants.NETWORK_NO;
        }
        return netWorkType;
    }
