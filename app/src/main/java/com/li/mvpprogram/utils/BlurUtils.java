...
public class BlurUtils {
    ...
    public void blur(View fromView, View toView, float radius, float scaleFactor) {
        ...
        overlay = blur(overlay, (int) radius);
        toView.setBackground(new BitmapDrawable(mContext.getResources(), overlay));
    }
