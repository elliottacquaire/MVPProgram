 ...
 *
 * @author ex-heguogui
 * @version v 1.4.0 2017/1/9 11:45 XLXZ Exp $
...
public class PasswordInputView extends EditText {
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        borderColor = context.getResources().getColor(R.color.common_password);
        passwordColor = context.getResources().getColor(R.color.common_password);
