...
//						ToastUtils.toastForLong(mContext, msg);
    ...
    private String obtainExceptionInfo(Throwable throwable) {
        ...
        LogUtils.e(throwable, mStringWriter.toString());
    ...
    private String getPath() {
        String path = DeviceUtils.getExternalStoragePath("crash", BaseApplication.getInstance().getApplicationContext());
        if (path == null) {
            path = AppUtils.getCacheDirPath(BaseApplication.getInstance().getApplicationContext());
        }
        return path;
    }
     ...
     * 上传异常信息到服务器
     */
    private void updateExceptionToServer(Throwable ex) {
//        ClientLogVo clientLogVo = ClientLogVo.builder().message(obtainExceptionInfo(ex)).build();
//        RetrofitUtil.createService()
//                .putClientLog(RpcHelper.getParamMap(ApiMethod.METHOD_PUT_CLICNET_LOG, Collections.singletonList(clientLogVo)))
