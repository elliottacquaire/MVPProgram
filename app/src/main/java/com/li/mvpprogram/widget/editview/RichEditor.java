...
import com.li.mvpprogram.widget.editview.modle.InsertModel;
...
public class RichEditor extends AppCompatEditText {
    ...
    public RichEditor(Context context, AttributeSet attrs) {
        ...
        setFilters(filters);
        size = ScreenTools.instance(context).dip2px(20);
        initView();
    }
    ...
    public void insertIcon(String name) {
        ...
        /*CharSequence charSequence = AndroidEmoji.ensure(name.toString());
        if (index < 50) {
            spannableStringBuilder.insert(index, charSequence);
            setText(spannableStringBuilder);
            setSelection(index + charSequence.length());
        }*/
    }
