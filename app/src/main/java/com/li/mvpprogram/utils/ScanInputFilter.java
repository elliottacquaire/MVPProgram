 ...
 * @version v 3.0.3 2017/9/6 17:46
 * @email ex-caoyanchang@xianglin.cn
 * 1.小数点前9位数</br>
 * 2.小数点后2位数
 */

public class ScanInputFilter implements InputFilter {
    Pattern mPattern;
    ...
    public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
        ...
        if (destText.contains(POINTER)) {
            ...
            if (!matcher.matches()) {
                ...
                if ((POINTER.equals(source.toString())) && TextUtils.isEmpty(destText)) {  //首位输入小数点，则显示0.
                    return ZERO + POINTER;
