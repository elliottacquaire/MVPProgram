...
public class StepArcView extends View {
    ...
    private float mTextStepWidth = 0;
    /**
     * 步数
     */
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.game_green));//设置画笔颜色
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        ...
        vTextPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
