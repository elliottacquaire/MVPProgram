...
public class KeyboardUtils {
    ...
    public static final void hideInputMethod(FragmentActivity acitivity) {
        if (acitivity != null) {
            ...
            if (acitivity.getWindow() != null && acitivity.getWindow().getDecorView() != null) {
                imm.hideSoftInputFromWindow(acitivity.getWindow().getDecorView().getApplicationWindowToken(), 2);
            }
        }
